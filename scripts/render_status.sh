...
PYTHONIOENCODING=utf-8 STATUS_DIR="$status_dir" SHOW_SUBAGENTS="$show_subagents" RENDER_MODE="$render_mode" DAEMON_JSON="$daemon_json" python3 "$SCRIPT_DIR/render_status.py"
